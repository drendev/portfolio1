...
export const Logo = () => {
    return (
        <a href="/" className="tracking-[-0.13px] bg-gradient-to-b from-[#e9e9e9] via-[#e9e9e9] to-[#ffffff] rounded-[13.66px] flex-none p-[3.54px] transition-all duration-200 overflow-visible active:from-[#e0e0e0] active:via-[#fefefe] active:to-[#fefefe]">
